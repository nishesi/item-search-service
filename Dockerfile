...
COPY src/main/resources/application.yaml /var/local/application.yaml
ENTRYPOINT ["java","-Xmx256m","-jar","/app/program-0.0.1.jar","--spring.config.location=file:/var/local/application.yaml","-Dfile.encoding=UTF-8", "-Dconsole.encoding=UTF-8"]
