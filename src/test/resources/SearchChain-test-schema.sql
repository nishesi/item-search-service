...
values (1, 101, 1001, 'name_1', 'description_1', '/item_url1', 'type_1', 'some_image', 'brand_1', 'catalogue_1'),
       ...
       (3, 101, 1001, 'Something 200003', 'description_1', '/item_url2', '300001', 'some_image', 'brand_1',
        'catalogue_1'),
       (4, 102, 1001, '200003 Another', 'description_1', '/item_url2', '300001', 'some_image', 'brand_1',
        'catalogue_2'),
       (5, 102, 1001, 'Something 200003 Another', 'description_1', '/item_url2', '300001', 'some_image', 'brand_1',
        'catalogue_2'),
